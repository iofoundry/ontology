...
The IOF-PPRO is a reference ontology for the domain of manufacturing/production planning that resides under  the IOF Core ontology (it imports IOF Core)  As a reference ontology, IOF-PPRO contains terms used by most industries utilizing data interoperability in their production planning activities in relation to various PLM, ERP, MES, and/or MOM software.
