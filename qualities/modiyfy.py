...
def do_stuff():
    old_rdf_file = "Qualities-Morphological.rdf"
...
#merge_g("Qualities-Morphological.rdf","Qualities-Morphological copy.rdf")

#move_owl_classes_with_skos_definition('mod2.rdf', 'mod2-sort.rdf')
restore_reference("Qualities-Morphological.rdf","morph_old.rdf")
#add_rdfs_label_to_classes("Qualities-Morphological.rdf")
